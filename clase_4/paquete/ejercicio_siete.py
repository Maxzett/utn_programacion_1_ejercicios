...
def calcular_impuestos_nacionales(valor_ventas_nacionales:float, iva:int = 21) -> float:
    resultado_nacional = valor_ventas_nacionales* (1 / (1 + (iva / 100)))
    return resultado_nacional

def calcular_impuestos_exportacion(valor_exportaciones:float, retenciones:int = 15) -> float:
    resultado_exportaciones = valor_exportaciones* (1 - (retenciones / 100))
    return resultado_exportaciones

def sumar_impuestos(resultado_nacional:float, resultado_exportaciones:float) -> float:
